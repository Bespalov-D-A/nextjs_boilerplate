  ...
  return (
    <div className={styles.cooperationWrap}>
      ...
      <div className={styles.contentWrap}>
        <span className={styles.content}>Feel free to visit our Partnerships page or email us at <a className={styles.link} href="">partnerships@rentycars.com</a> with a brief overview of your car rental company.
